...
<section id="hpServers" class="container-fluid productSection centeredH1">
    ...
    <div class="row featurette" style="padding: 25px 25px 25px 25px">
        <div class="col-md-7" style="padding-left: 75px; padding-right: 75px; padding-top: 25px">
            ...
            <p class="lead">Get the right compute, for the right workload, at the right economics — every time. Redefine
                compute economics, accelerate IT service delivery, and boost business performance with:
                the highest availability, scalability and performance on x86, thanks to new HP Integrity Superdome X and
                HP Integrity NonStop X servers.
                reduced complexity of managing blade and rack infrastructures with automation simplicity from HP
                ProLiant Gen9 and HP OneView.
                cost-optimized cloud through new HP Cloudline — servers built to scale with open design principles
                specifically for service providers.</p>
        </div>
        <div class="col-md-5">
            <img class="featurette-image img-responsive img-rounded" src="images/hpServer.jpg"
...
<section id="businessPrinters" class="container-fluid productSection centeredH1">
    ...
    <div class="row featurette" style="padding: 25px 25px 25px 25px">
        <div class="col-md-7" style="padding-left: 100px; padding-right: 100px; padding-top: 100px">
            <h2 class="featurette-heading">The HP top laser performance, plus extra paper input. <span
                    class="text-muted">It'll blow your mind.</span></h2>

            <p class="lead">Get amazing speed, productivity, networking and stunning quality in the HP top wide-format
                color laser printer. It's dependable, flexible and provides high-volume printing up to 40 ppm. Print
                marketing materials up to 12 x 18 and banners up to 12 x 36.</p>
        </div>
        <div class="col-md-5">
            <img class="featurette-image img-responsive img-rounded" src="images/printer.jpg"
                 alt="Generic placeholder image">
        </div>
    </div>
...
<section id="newProducts" class="container-fluid productSection centeredH1">
    ...
    <div class="row featurette" style="padding: 25px 25px 25px 25px">
        <div class="col-md-5" style="padding-left: 100px">
            <img class="featurette-image img-responsive img-rounded" src="images/cisco.jpg"
                 alt="Generic placeholder image">
        </div>
        <div class="col-md-7" style="padding-left: 100px; padding-right: 100px; padding-top: 100px">
            <h2 class="featurette-heading">Benefit by Integrating Applications. <span class="text-muted">It'll blow your mind.</span>
            </h2>

            <p class="lead">Deliver the lowest total cost of ownership and the highest return on investment. The Cisco
                Integrated Services Routers Generation 2 (ISR G2) reduces operational costs by 50 to 75 percent per
                year.</p>
        </div>
    </div>
    <a id="topLinks" href="products.php" target="_top">Top</a>
