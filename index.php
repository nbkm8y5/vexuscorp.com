                ...
                <div class="item active">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            ...
                            <p><a class="btn btn-lg btn-danger" href="products.php#hpServers" role="button">Check it
                                    out</a></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            ...
                            <p><a class="btn btn-lg btn-danger" href="products.php#businessPrinters" role="button">Come
                                    on in</a></p>
                        </div>
                    </div>
                </div>
...
<section>
    <div class="container">
        <div class="row">
            ...
            <p>Vexus Corporation is committed to providing our customers with a leading portfolio of IT technology
                solutions as well as a variety of hardware and services to help you expand your solutions offering,
                reach more customers, and most importantly drive profits.</p>
        </div>
        <div class="row">
            <h2>WHAT WE DO!</h2>

            <p>Vexus Corporation is a leading global IT solutions distributor dedicated to accelerating the success of
                its customers by providing market-specific resources, expertise, services and tools. Vexus Corporation’s
                core solutions and services offerings expand across the hardware industry, providing cost-effective
                solutions that identify high-growth areas in key technologies and vertical markets. With these
                technology and market specializations provided by Vexus Corporation , partners can effectively address
                their customers’ needs and business challenges resulting in new market opportunities and increased
                revenue growth.

                Vexus Corporation expanded its operations in Latin America and the Caribbean, as a value–added
                distributor focused on delivering solutions from leading global IT suppliers. This expansion not only
                added new suppliers to the Vexus Corporation line card, it also positioned Vexus Corporation to develop
                new and existing customer relationships by extending its unique solutions and distribution strategy into
                high growth markets in region.</p>
        </div>
