...
<section id="hpRenew" class="container-fluid productSection centeredH1">
    ...
    <div class="row featurette">
        <div class="col-md-7">
            ...
            <p class="lead">Whether your organization is looking to implement a new IT platform or planning to maintain
                or upgrade your existing one, HP Renew offers a comprehensive portfolio of enterprise products to
                fulfill your specific business needs.</p>
        </div>
        <div class="col-md-5">
