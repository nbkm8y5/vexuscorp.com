            ...
            <form action="join_confirmation.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="businessName" name="businessname"
                           placeholder="Enter business name" value="<?php //echo "$businessName"; ?>" required>
                </div>
                <div class="form-group">
                    <label for="businessAddress">Business Address</label>
                    <input type="text" class="form-control" id="businessAddress" name="businessaddress"
                           placeholder="Enter business address" value="<?php //echo "$businessAddress"; ?>" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="email" name="email"
                           placeholder="Business email address please" value="<?php echo "$email"; ?>" required>
                </div>
                <div class="form-group">
